...
design_source = design_source[(design_source.hom_start>=start_position - cover_exon_upstream) & (design_source.hom_stop<=stop_position+cover_exon_upstream)]
...
for region_index, (start, stop) in enumerate(region_list):
    ...
    if not overlap(start,stop, start_position,stop_position):
        continue
