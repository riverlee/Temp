...
parser.add_argument("--allow_snps_in_homs_distance", dest="allow_snps_in_homs_distance", help="What's the mininal distance to allow snps in homs to the end of upsteam and start of downstream",type=int,default=5)
...
rewrite_pair_file=args.rewrite_pair_file
